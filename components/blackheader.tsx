...
export default function BlackHeader() {
  ...
  return (
    <>
      {/* Header */}
      <header className="absolute top-0 left-0 right-0 z-30 text-white flex items-center justify-between px-4 sm:px-8 md:px-12 py-6 bg-transparent">
        {/* Left spoon button */}
        <button
      ...
      <motion.aside
        ...
        className="fixed top-0 left-0 h-full w-64 md:w-72 bg-black text-white z-50 shadow-lg overflow-auto p-6"
      >
        <button
          onClick={() => setSidebarOpen(false)}
          className="mb-4 text-white hover:text-gray-400 text-[25px]"
        >
          ×
        </button>
